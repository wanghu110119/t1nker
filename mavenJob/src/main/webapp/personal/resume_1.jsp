									...
									<table width="100%" border="0" cellspacing="0" cellpadding="4">
										<tr>
											<td height="50" colspan="2" bgcolor="#F5FAFC"
												style=" border-bottom:1px #CCCCCC dashed; color:#003399">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
										...
										<tr>
											...
											<td><input name="resumename" type="text" required="required"
										...
										<tr>
											...
											<td><input name="name" type="text"
												class="input_text_200" id="fullname" maxlength="6" value="" required="required" />
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input name="birthday" type="text" required="required"
										...
										<tr>
											...
											<td><input name="height" type="text"
												class="input_text_200" id="height" maxlength="3" required="required"
										...
										<tr>
											...
											<td><label><input name="married" type="radio"
												...
												<label><input type="radio" name="married" value="2"
													...
													type="radio" name="married" value="3" title="保密" /> 保密</label> 
													<input name="marriage_cn" id="marriage_cn" type="hidden" value="" />
											</td>
										</tr>
										<tr>
											<td height="23" align="right"><strong
											...
											<td>
												...
												<!-- <div id="menu1" class="menu1" style="position: relative;">
														<ul>
										...
										<tr>
											...
											<option value="" ><input type="checkbox"
																	name="checkbox" value="155,形象好" id="155" title="形象好" />形象好</option>
											<option value="" ></option>
											<option value="" ></option>
											<option value="" ></option>
											<option value="" ></option>
										...
										<tr>
											...
											<td><input name="phone" type="text" required="required"
										...
										<tr>
											...
											<c:if test="${sessionScope.user.state eq 'false'}">
												<a href="sendmail.do" style="color:#FF3300"> [点击认证]</a>
											</c:if>
											<c:if test="${sessionScope.user.state eq 'true'} ">
												<span  style="color:#FF3300"> [邮箱已认证]</span>
											</c:if>
										...
										<tr>
											...
											<td><input name="address" type="text" required="required"
										...
										<tr>
											...
											<td><label><input name="get"
													type="radio" value="1" checked="checked" />接收</label>
												&nbsp;&nbsp;&nbsp; <label> <input type="radio"
													name="get" value="0" checked="checked" />不接收
											</label> <span style="color: #666666">
													&nbsp;&nbsp;&nbsp;(当企业对您发起面试邀请，系统会发一份邮件提醒您查看)</span></td>
										</tr>
										<tr>
											<td height="23" align="right">接收邮箱：</td>
											<td><strong>${sessionScope.user.email }</strong>&nbsp;&nbsp;&nbsp; <span
												style="color:#FF0000">
												 <c:if test="${sessionScope.user.state eq 'false'}">
												<a href="sendmail.do" style="color:#FF3300"> [邮箱未认证]</a>
											</c:if>
											<c:if test="${sessionScope.user.state eq 'true'} ">
												<span  style="color:#FF3300"> [邮箱已认证]</span>
											</c:if>
