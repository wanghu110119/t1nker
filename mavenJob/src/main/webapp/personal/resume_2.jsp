	...
	<div class="user_right_box">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="4" o >
            ...
            <tr>
              ...
              <td><input name="nearjob" type="text" class="input_text_200" id="recentjobs" maxlength="40" style="width:280px;" value=""/><span style="color:#999999"> (无工作经验者可忽略)</span></td>
            </tr>
            <tr>
              <td height="23" align="right"><strong  style="color:#FF0000">*</strong>期望岗位性质：</td>
              <td>		  
			  		   <label><input name="jobtype"  type="radio" value="2"   / title="全职">全职</label>  &nbsp;&nbsp;&nbsp;&nbsp;
		 		   <label><input name="jobtype"  type="radio" value="1"   / title="兼职">兼职</label>  &nbsp;&nbsp;&nbsp;&nbsp;
		 		   <label><input name="jobtype"  type="radio" value="0"   / title="实习">实习</label>  &nbsp;&nbsp;&nbsp;&nbsp;
			  ...
			  <div>
									<!-- <script type="text/javascript">
										/* $(document).ready(function(){
											$("district_cn").click(function(){
												("menu2").appen
											});
										
										}); */
			window.onload = function () { 
				var btn = document.getElementById("district_cn"); 
		...
		//		var oTest = document.getElementById("box-one"); 
				...
				alert(''); 
				newNode.innerHTML =  
				"<ul><li id="1" title="北京市">北京市</li><li id="2" title="上海市">上海市</li><li id="3" title="天津市">天津市</li></ul>"
				oTest.appendChild(newNode); 
			//	oTeset.insertBefore(newNode,null); // 这两种方法均可实现 
			} 
										</script> -->
		<input type="text" value="期望工作地区"  readonly="readonly" name="workplace" id="district_cn" class="input_text_200 input_text_200_selsect"/>
		...
		<div id="menu1" class="menu">
			<ul>
						...
						<select name="money" style="width:208px;height:26px">
													<option value="请选择期望月薪" disabled="disabled">请选择期望月薪		</option>
