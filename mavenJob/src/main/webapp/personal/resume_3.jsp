	...
	<div class="user_right_box">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
		  ...
		  <form id="Form1" name="Form1" method="post" action="resume3.do"  >
		  <table width="100%" border="0" cellspacing="0" cellpadding="4" style=" line-height:180%;">
            ...
            <tr>
              ...
              <td><textarea name="jobAdvantage"   id="specialty" style=" width:450px; height:100px; font-size:12px; line-height:160%;" ></textarea><br />
</td>
            </tr>
			<tr>
